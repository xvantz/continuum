...
export const CONTINUUM_GRAPH: Graph = {
  ...
  nodes: [
    ...
    { nodeId: "db", kind: "db", concurrency: 1 },
  ...
  edges: [
    ...
    { edgeId: "main-db", from: "process-main", to: "db" },
    { edgeId: "fallback-db", from: "process-fallback", to: "db" },
    { edgeId: "db-persist", from: "db", to: "persist" },
